...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.ecommerce.admin")).paths(PathSelectors.any()).build()
				.apiInfo(apiInfo()).securitySchemes(securitySchemes())
				.securityContexts(Arrays.asList(securityContext()));
	}

	public ApiInfo apiInfo() {
		return new ApiInfo("Auction REST API", "AUC Rest API Ecommerce", "1.0", "Terms of service",
				new Contact("Ecommerce Auction", "www.ecommerce.com", "longtam20015@gmail.com"), "License of API",
